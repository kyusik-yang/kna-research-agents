...
\begin{figure}[htbp]
\centering
\fbox{\parbox{0.85\textwidth}{[Figure generated by R script above. Lollipop chart showing committee-level passage rate changes around December 3, 2024. Social policy committees cluster at large negative values ($-25$ to $-41$ pp), the Judiciary Committee shows a moderate decline ($-18$ pp), and the Strategy/Finance Committee is a positive outlier ($+28$ pp). Committees are colored by type using a colorblind-safe palette.]}}
...
\begin{figure}[htbp]
\centering
\fbox{\parbox{0.85\textwidth}{[Figure generated by R script above. Bar chart showing special counsel bill counts across the 17th through 22nd National Assemblies. Total introductions escalate from 12--19 in the 17th--19th to 70 in the 22nd. The 22nd Assembly is the first to produce a substantial number of floor rejections (eight), indicating serial reintroduction cycles that consume legislative bandwidth.]}}
